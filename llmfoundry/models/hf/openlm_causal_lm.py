...
__all__ = ['ComposerOpenLMCausalLM']

Tokenizer = Union[PreTrainedTokenizer, PreTrainedTokenizerFast]


class ComposerOpenLMCausalLM(HuggingFaceModelWithZLoss):
    ...
    def __init__(self, om_model_config: DictConfig, tokenizer: Tokenizer):
        ...
        config = OpenLMConfig.from_pretrained(
        ...
        if init_device == 'cpu':
            if om_model_config.pretrained:
                ...
                model = OpenLMForCausalLM.from_config(
                    config,
                    trust_remote_code=trust_remote_code,
                )
